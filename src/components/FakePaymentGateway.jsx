      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 px-4">
        <div className="w-full max-w-md rounded-3xl bg-white p-8 text-center shadow-2xl">
          ...
          <p className="mt-3 text-gray-600">
            Your Mattie's Coffee order has been placed.
          </p>
          ...
          <p className="mt-3 text-sm text-gray-500">
            Demo transaction ID: MATTIE-{Date.now()}
          </p>
      ...
      <div className="w-full max-w-lg rounded-3xl bg-white p-6 shadow-2xl md:p-8">
        ...
        <div className="mt-6 rounded-2xl bg-gray-900 p-6 text-white">
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm">DEMO CARD</span>
          </div>
        ...
        <div className="mt-5 rounded-xl bg-amber-50 p-4 text-sm text-amber-900">
          <p className="font-bold">Demo payment details</p>
        ...
        <form onSubmit={handlePayment} className="mt-6 space-y-4">
          ...
          <p className="text-center text-xs text-gray-500">
            This is a demonstration gateway. No real payment is processed or
            stored.
          </p>
        </form>
      </div>
